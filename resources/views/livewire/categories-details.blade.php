<div class="bg-[#E3FDFD] pb-10 xl:w-[30%] w-full m-auto">
    <h1 class="text-3xl font-bold pt-20 pb-3 xl:pt-24 text-slate-700 text-center">Kategori {{ $judulCategory }}</h1>
    ...
    <div class="w-full px-5">
        ...
        <div class="flex justify-start items-baseline w-full flex-wrap gap-y-5">
